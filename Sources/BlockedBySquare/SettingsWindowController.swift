...
class SettingsWindowController: NSWindowController, NSWindowDelegate {
  ...
  private func buildUI() {
    ...
    do {
      ...
      let bottomRow = NSStackView(views: [
        bottomLabel, bottomPhraseField, bottomLightStack, bottomDarkStack,
      ])
      bottomRow.spacing = 8
      ...
      let topPaddingRow = NSStackView(views: [
        topPaddingLabel, topPaddingField, topPaddingStepper, topPadReset,
      ])
      ...
      let bottomPadReset = NSButton(
        title: "Reset", target: self, action: #selector(resetBottomPadding))
      ...
      let bottomPaddingRow = NSStackView(views: [
        bottomPaddingLabel, bottomPaddingField, bottomPaddingStepper, bottomPadReset,
      ])
  ...
  @objc private func phraseFieldChanged(_ notification: Notification) {
    previewWindow?.updatePhrases(
      top: topPhraseField.stringValue,
  ...
  private func commitPadding() {
    ...
    previewWindow?.updatePadding(
      top: CGFloat(Settings.shared.topPadding), bottom: CGFloat(Settings.shared.bottomPadding))
  }
...
private class PreviewWindow: NSWindow {
  ...
  init() {
    ...
    overlayView.updatePhrases(
      top: Settings.shared.topPhrase,
      bottom: Settings.shared.bottomPhrase)
    let s = Settings.shared
    overlayView.updateTextColors(
      topLight: s.topPhraseColorLight, topDark: s.topPhraseColorDark,
      bottomLight: s.bottomPhraseColorLight, bottomDark: s.bottomPhraseColorDark)
  }
